    ...
    <div className={styles.stack}>
                    ...
                    >
                      <div className={styles.cardHead}>
                        <span className={styles.icon}>
                          <Icon name={reward.icon as IconName} size={22} />
                        </span>
      ...
      <Card as="section" aria-labelledby="history-heading">
        <CardHeader
          ...
          subtitle="Everything you have claimed so far"
        />
            ...
            {history.map((entry) => (
              <li key={entry.id} className={styles.historyRow}>
                <span className={styles.historyIcon}>
                  <Icon name={entry.reward_icon as IconName} size={18} />
                </span>
